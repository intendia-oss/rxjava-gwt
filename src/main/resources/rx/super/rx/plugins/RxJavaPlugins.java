...
public class RxJavaPlugins {
    ...
    public RxJavaErrorHandler getErrorHandler() {
        if (errorHandler.get() == null) {
            ...
            Object impl = null; // GwtIncompatible: getPluginImplementationViaProperty(RxJavaErrorHandler.class);
            if (impl == null) {
    ...
    public RxJavaObservableExecutionHook getObservableExecutionHook() {
        if (observableExecutionHook.get() == null) {
            // check for an implementation from System.getProperty first
            Object impl = null; // GwtIncompatible: getPluginImplementationViaProperty(RxJavaObservableExecutionHook.class);
            if (impl == null) {
                // nothing set via properties so initialize with default 
    ...
    public RxJavaSchedulersHook getSchedulersHook() {
        if (schedulersHook.get() == null) {
            // check for an implementation from System.getProperty first
            Object impl = null; // GwtIncompatible: getPluginImplementationViaProperty(RxJavaSchedulersHook.class);
            if (impl == null) {
                // nothing set via properties so initialize with default
