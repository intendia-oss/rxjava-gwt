...
/* package */final class SubjectSubscriptionManager<T> implements OnSubscribe<T> {
    ...
    static final AtomicReferenceFieldUpdater<SubjectSubscriptionManager, State> STATE_UPDATER
            = new rx.internal.util.GwtReferenceFieldUpdater<SubjectSubscriptionManager,State>() { @Override protected State getter(SubjectSubscriptionManager obj) { return obj.state; } @Override protected void setter(SubjectSubscriptionManager obj, State update) { obj.state = update; } };
    ...
    static final AtomicReferenceFieldUpdater<SubjectSubscriptionManager, Object> LATEST_UPDATER
            = new rx.internal.util.GwtReferenceFieldUpdater<SubjectSubscriptionManager,Object>() { @Override protected Object getter(SubjectSubscriptionManager obj) { return obj.latest; } @Override protected void setter(SubjectSubscriptionManager obj, Object update) { obj.latest = update; } };
