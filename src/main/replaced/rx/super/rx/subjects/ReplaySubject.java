...
public final class ReplaySubject<T> extends Subject<T, T> {
    ...
    static final class UnboundedReplayState<T> implements ReplayState<T, Integer> {
        ...
        static final AtomicIntegerFieldUpdater<UnboundedReplayState> INDEX_UPDATER
                = new rx.internal.util.GwtIntegerFieldUpdater<UnboundedReplayState>() { @Override protected int getter(UnboundedReplayState obj) { return obj.index; } @Override protected void setter(UnboundedReplayState obj, int update) { obj.index = update; } };
