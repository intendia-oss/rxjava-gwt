...
public final class SerialSubscription implements Subscription {
    ...
    static final AtomicReferenceFieldUpdater<SerialSubscription, State> STATE_UPDATER
            = new rx.internal.util.GwtReferenceFieldUpdater<SerialSubscription,State>() { @Override protected State getter(SerialSubscription obj) { return obj.state; } @Override protected void setter(SerialSubscription obj, State update) { obj.state = update; } };
