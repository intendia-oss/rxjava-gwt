...
public final class BooleanSubscription implements Subscription {
    ...
    static final AtomicIntegerFieldUpdater<BooleanSubscription> UNSUBSCRIBED_UPDATER
            = new rx.internal.util.GwtIntegerFieldUpdater<BooleanSubscription>() { @Override protected int getter(BooleanSubscription obj) { return obj.unsubscribed; } @Override protected void setter(BooleanSubscription obj, int update) { obj.unsubscribed = update; } };
