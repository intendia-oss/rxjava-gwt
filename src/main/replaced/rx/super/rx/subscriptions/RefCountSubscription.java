...
public final class RefCountSubscription implements Subscription {
    ...
    static final AtomicReferenceFieldUpdater<RefCountSubscription, State> STATE_UPDATER
            = new rx.internal.util.GwtReferenceFieldUpdater<RefCountSubscription,State>() { @Override protected State getter(RefCountSubscription obj) { return obj.state; } @Override protected void setter(RefCountSubscription obj, State update) { obj.state = update; } };
    ...
    private static final class InnerSubscription implements Subscription {
        ...
        static final AtomicIntegerFieldUpdater<InnerSubscription> INNER_DONE_UPDATER
                = new rx.internal.util.GwtIntegerFieldUpdater<InnerSubscription>() { @Override protected int getter(InnerSubscription obj) { return obj.innerDone; } @Override protected void setter(InnerSubscription obj, int update) { obj.innerDone = update; } };
