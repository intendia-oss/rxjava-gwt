...
public final class OnSubscribeFromIterable<T> implements OnSubscribe<T> {
    ...
    private static final class IterableProducer<T> implements Producer {
        ...
        private static final AtomicLongFieldUpdater<IterableProducer> REQUESTED_UPDATER = new rx.internal.util.GwtLongFieldUpdater<IterableProducer>() { @Override protected long getter(IterableProducer obj) { return obj.requested; } @Override protected void setter(IterableProducer obj, long update) { obj.requested = update; } };
