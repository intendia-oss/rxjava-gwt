...
public class OperatorGroupBy<T, K, R> implements Operator<GroupedObservable<K, R>, T> {
    ...
    static final class GroupBySubscriber<K, T, R> extends Subscriber<T> {
        ...
        static final AtomicIntegerFieldUpdater<GroupBySubscriber> WIP_FOR_UNSUBSCRIBE_UPDATER = new rx.internal.util.GwtIntegerFieldUpdater<GroupBySubscriber>() { @Override protected int getter(GroupBySubscriber obj) { return obj.wipForUnsubscribe; } @Override protected void setter(GroupBySubscriber obj, int update) { obj.wipForUnsubscribe = update; } };
        ...
        @SuppressWarnings("rawtypes")
        static final AtomicIntegerFieldUpdater<GroupBySubscriber> COMPLETION_EMITTED_UPDATER = new rx.internal.util.GwtIntegerFieldUpdater<GroupBySubscriber>() { @Override protected int getter(GroupBySubscriber obj) { return obj.completionEmitted; } @Override protected void setter(GroupBySubscriber obj, int update) { obj.completionEmitted = update; } };
        @SuppressWarnings("rawtypes")
        static final AtomicIntegerFieldUpdater<GroupBySubscriber> TERMINATED_UPDATER = new rx.internal.util.GwtIntegerFieldUpdater<GroupBySubscriber>() { @Override protected int getter(GroupBySubscriber obj) { return obj.terminated; } @Override protected void setter(GroupBySubscriber obj, int update) { obj.terminated = update; } };

        volatile long requested;
        @SuppressWarnings("rawtypes")
        static final AtomicLongFieldUpdater<GroupBySubscriber> REQUESTED = new rx.internal.util.GwtLongFieldUpdater<GroupBySubscriber>() { @Override protected long getter(GroupBySubscriber obj) { return obj.requested; } @Override protected void setter(GroupBySubscriber obj, long update) { obj.requested = update; } };

        volatile long bufferedCount;
        @SuppressWarnings("rawtypes")
        static final AtomicLongFieldUpdater<GroupBySubscriber> BUFFERED_COUNT = new rx.internal.util.GwtLongFieldUpdater<GroupBySubscriber>() { @Override protected long getter(GroupBySubscriber obj) { return obj.bufferedCount; } @Override protected void setter(GroupBySubscriber obj, long update) { obj.bufferedCount = update; } };
