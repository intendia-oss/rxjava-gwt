...
public final class OperatorSampleWithTime<T> implements Operator<T, T> {
    ...
    static final class SamplerSubscriber<T> extends Subscriber<T> implements Action0 {
        ...
        static final AtomicReferenceFieldUpdater<SamplerSubscriber, Object> VALUE_UPDATER
                = new rx.internal.util.GwtReferenceFieldUpdater<SamplerSubscriber,Object>() { @Override protected Object getter(SamplerSubscriber obj) { return obj.value; } @Override protected void setter(SamplerSubscriber obj, Object update) { obj.value = update; } };
