...
public final class OperatorMergeMaxConcurrent<T> implements Operator<T, Observable<? extends T>> {
    ...
    static final class SourceSubscriber<T> extends Subscriber<Observable<? extends T>> {
        ...
        static final AtomicIntegerFieldUpdater<SourceSubscriber> WIP
                = new rx.internal.util.GwtIntegerFieldUpdater<SourceSubscriber>() { @Override protected int getter(SourceSubscriber obj) { return obj.wip; } @Override protected void setter(SourceSubscriber obj, int update) { obj.wip = update; } };
        volatile int sourceIndex;
        @SuppressWarnings("rawtypes")
        static final AtomicIntegerFieldUpdater<SourceSubscriber> SOURCE_INDEX
                = new rx.internal.util.GwtIntegerFieldUpdater<SourceSubscriber>() { @Override protected int getter(SourceSubscriber obj) { return obj.sourceIndex; } @Override protected void setter(SourceSubscriber obj, int update) { obj.sourceIndex = update; } };
        ...
        static final AtomicLongFieldUpdater<SourceSubscriber> REQUESTED
                = new rx.internal.util.GwtLongFieldUpdater<SourceSubscriber>() { @Override protected long getter(SourceSubscriber obj) { return obj.requested; } @Override protected void setter(SourceSubscriber obj, long update) { obj.requested = update; } };
        ...
        public SourceSubscriber(int maxConcurrency, Subscriber<T> s, CompositeSubscription csub) {
            ...
            this.subscribers = new ArrayList<MergeItemSubscriber>();
            this.wip = 1;
        }
        ...
        protected void drain() {
            ...
            final List<MergeItemSubscriber> subs = subscribers;
