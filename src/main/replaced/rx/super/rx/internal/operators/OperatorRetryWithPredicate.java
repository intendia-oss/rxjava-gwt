...
public final class OperatorRetryWithPredicate<T> implements Observable.Operator<T, Observable<T>> {
    ...
    static final class SourceSubscriber<T> extends Subscriber<Observable<T>> {
        ...
        static final AtomicIntegerFieldUpdater<SourceSubscriber> ATTEMPTS_UPDATER
                = new rx.internal.util.GwtIntegerFieldUpdater<SourceSubscriber>() { @Override protected int getter(SourceSubscriber obj) { return obj.attempts; } @Override protected void setter(SourceSubscriber obj, int update) { obj.attempts = update; } };
