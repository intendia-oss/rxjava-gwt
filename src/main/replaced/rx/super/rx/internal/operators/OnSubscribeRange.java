...
public final class OnSubscribeRange implements OnSubscribe<Integer> {
    ...
    private static final class RangeProducer implements Producer {
        ...
        private static final AtomicLongFieldUpdater<RangeProducer> REQUESTED_UPDATER = new rx.internal.util.GwtLongFieldUpdater<RangeProducer>() { @Override protected long getter(RangeProducer obj) { return obj.requested; } @Override protected void setter(RangeProducer obj, long update) { obj.requested = update; } };
        private long index;
        private final int end;
