...
public final class OperatorZip<R> implements Operator<R, Observable<?>[]> {
    ...
    private static final class Zip<R> {
        ...
        @SuppressWarnings("rawtypes")
        static final AtomicLongFieldUpdater<Zip> COUNTER_UPDATER = new rx.internal.util.GwtLongFieldUpdater<Zip>() { @Override protected long getter(Zip obj) { return obj.counter; } @Override protected void setter(Zip obj, long update) { obj.counter = update; } };
