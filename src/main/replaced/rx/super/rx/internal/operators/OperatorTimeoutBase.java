...
class OperatorTimeoutBase<T> implements Operator<T, T> {
    ...
    /* package-private */static final class TimeoutSubscriber<T> extends
        ...
        static final AtomicIntegerFieldUpdater<TimeoutSubscriber> TERMINATED_UPDATER
                = new rx.internal.util.GwtIntegerFieldUpdater<TimeoutSubscriber>() { @Override protected int getter(TimeoutSubscriber obj) { return obj.terminated; } @Override protected void setter(TimeoutSubscriber obj, int update) { obj.terminated = update; } };
        @SuppressWarnings("rawtypes")
        static final AtomicLongFieldUpdater<TimeoutSubscriber> ACTUAL_UPDATER
                = new rx.internal.util.GwtLongFieldUpdater<TimeoutSubscriber>() { @Override protected long getter(TimeoutSubscriber obj) { return obj.actual; } @Override protected void setter(TimeoutSubscriber obj, long update) { obj.actual = update; } };
