...
public final class BackpressureDrainManager implements Producer {
    ...
    = new rx.internal.util.GwtLongFieldUpdater<BackpressureDrainManager>() { @Override protected long getter(BackpressureDrainManager obj) { return obj.requestedCount; } @Override protected void setter(BackpressureDrainManager obj, long update) { obj.requestedCount = update; } };
