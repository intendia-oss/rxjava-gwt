...
abstract class PaddedAtomicIntegerBase extends FrontPadding {
    ...
    static {
        updater = new rx.internal.util.GwtIntegerFieldUpdater<PaddedAtomicIntegerBase>() { @Override protected int getter(PaddedAtomicIntegerBase obj) { return obj.value; } @Override protected void setter(PaddedAtomicIntegerBase obj, int update) { obj.value = update; } };
    }
