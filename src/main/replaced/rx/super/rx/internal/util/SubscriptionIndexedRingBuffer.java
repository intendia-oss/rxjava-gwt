...
public final class SubscriptionIndexedRingBuffer<T extends Subscription> implements Subscription {
    ...
    private final static AtomicIntegerFieldUpdater<SubscriptionIndexedRingBuffer> UNSUBSCRIBED = new rx.internal.util.GwtIntegerFieldUpdater<SubscriptionIndexedRingBuffer>() { @Override protected int getter(SubscriptionIndexedRingBuffer obj) { return obj.unsubscribed; } @Override protected void setter(SubscriptionIndexedRingBuffer obj, int update) { obj.unsubscribed = update; } };
