...
final class TakeLastQueueProducer<T> implements Producer {
    ...
    private static final AtomicLongFieldUpdater<TakeLastQueueProducer> REQUESTED_UPDATER = new rx.internal.util.GwtLongFieldUpdater<TakeLastQueueProducer>() { @Override protected long getter(TakeLastQueueProducer obj) { return obj.requested; } @Override protected void setter(TakeLastQueueProducer obj, long update) { obj.requested = update; } };
