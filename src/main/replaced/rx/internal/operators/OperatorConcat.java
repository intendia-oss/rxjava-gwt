...
public final class OperatorConcat<T> implements Operator<T, Observable<? extends T>> {
    ...
    static final class ConcatSubscriber<T> extends Subscriber<Observable<? extends T>> {
        ...
        static final AtomicIntegerFieldUpdater<ConcatSubscriber> WIP_UPDATER = new rx.internal.util.GwtIntegerFieldUpdater<ConcatSubscriber>() { @Override protected int getter(ConcatSubscriber obj) { return obj.wip; } @Override protected void setter(ConcatSubscriber obj, int update) { obj.wip = update; } };

        // accessed by REQUESTED_UPDATER
        private volatile long requested;
        @SuppressWarnings("rawtypes")
        private static final AtomicLongFieldUpdater<ConcatSubscriber> REQUESTED_UPDATER = new rx.internal.util.GwtLongFieldUpdater<ConcatSubscriber>() { @Override protected long getter(ConcatSubscriber obj) { return obj.requested; } @Override protected void setter(ConcatSubscriber obj, long update) { obj.requested = update; } };
    ...
    static class ConcatInnerSubscriber<T> extends Subscriber<T> {
        ...
        @SuppressWarnings("rawtypes")
        private final static AtomicIntegerFieldUpdater<ConcatInnerSubscriber> ONCE_UPDATER = new rx.internal.util.GwtIntegerFieldUpdater<ConcatInnerSubscriber>() { @Override protected int getter(ConcatInnerSubscriber obj) { return obj.once; } @Override protected void setter(ConcatInnerSubscriber obj, int update) { obj.once = update; } };
