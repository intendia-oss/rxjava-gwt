...
public class OperatorMerge<T> implements Operator<T, Observable<? extends T>> {
    ...
    private static final class MergeProducer<T> implements Producer {
        ...
        static final AtomicLongFieldUpdater<MergeProducer> REQUESTED = new rx.internal.util.GwtLongFieldUpdater<MergeProducer>() { @Override protected long getter(MergeProducer obj) { return obj.requested; } @Override protected void setter(MergeProducer obj, long update) { obj.requested = update; } };
    ...
    private static final class InnerSubscriber<T> extends Subscriber<T> {
        ...
        @SuppressWarnings("rawtypes")
        static final AtomicIntegerFieldUpdater<InnerSubscriber> ONCE_TERMINATED = new rx.internal.util.GwtIntegerFieldUpdater<InnerSubscriber>() { @Override protected int getter(InnerSubscriber obj) { return obj.terminated; } @Override protected void setter(InnerSubscriber obj, int update) { obj.terminated = update; } };
