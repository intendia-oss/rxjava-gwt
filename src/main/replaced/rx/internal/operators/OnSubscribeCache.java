...
public final class OnSubscribeCache<T> implements OnSubscribe<T> {
    ...
    static final AtomicIntegerFieldUpdater<OnSubscribeCache> SRC_SUBSCRIBED_UPDATER
            = new rx.internal.util.GwtIntegerFieldUpdater<OnSubscribeCache>() { @Override protected int getter(OnSubscribeCache obj) { return obj.sourceSubscribed; } @Override protected void setter(OnSubscribeCache obj, int update) { obj.sourceSubscribed = update; } };
