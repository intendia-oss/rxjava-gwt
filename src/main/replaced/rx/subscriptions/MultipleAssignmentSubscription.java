...
public final class MultipleAssignmentSubscription implements Subscription {
    ...
    static final AtomicReferenceFieldUpdater<MultipleAssignmentSubscription, State> STATE_UPDATER
            = new rx.internal.util.GwtReferenceFieldUpdater<MultipleAssignmentSubscription,State>() { @Override protected State getter(MultipleAssignmentSubscription obj) { return obj.state; } @Override protected void setter(MultipleAssignmentSubscription obj, State update) { obj.state = update; } };
