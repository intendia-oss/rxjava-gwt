...
public final class OnSubscribeCombineLatest<T, R> implements OnSubscribe<R> {
    ...
    final static class MultiSourceProducer<T, R> implements Producer {
        ...
        private static final AtomicLongFieldUpdater<MultiSourceProducer> WIP = new rx.internal.util.GwtLongFieldUpdater<MultiSourceProducer>() { @Override protected long getter(MultiSourceProducer obj) { return obj.counter; } @Override protected void setter(MultiSourceProducer obj, long update) { obj.counter = update; } };
        ...
        public MultiSourceProducer(final Subscriber<? super R> child, final List<? extends Observable<? extends T>> sources, FuncN<? extends R> combinator) {
            ...
            this.haveValues = new boolean[n];
            this.completion = new boolean[n];
        }
